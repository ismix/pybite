...
class Collector:
    def __init__(self, parser_name, keyword, use_proxy=None):
        if use_proxy == 'tor':
        ...
        self.parser = getattr(siteparser, parser_name)(keyword, proxy_client=self.proxy_client)
    ...
    def _do_interbatch(self):
        if self.proxy_client is None:
            ...
            pass # self.proxy_client.change_identity()
